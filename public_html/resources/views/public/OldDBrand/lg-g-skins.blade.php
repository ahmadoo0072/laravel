...
<!-- Mirrored from dbrand.com/lg-g-skins by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Sep 2016 11:26:17 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <title>LG G5 Skins & Wraps // ACellShop</title>
...
<meta name="description" content="Looking for an LG G3, G4, or G5 skin? Look no further. ACellShop offers the most precisely LG G5 skins on the market and ships worldwide." />
<meta name="abstract" content="Looking for an LG G3, G4, or G5 skin? Look no further. ACellShop offers the most precisely LG G5 skins on the market and ships worldwide." />
<meta name="viewport" content="width=device-width, user-scalable=no" />
<meta name="generator" content="Drupal 7 (http://drupal.org)" />
<link rel="canonical" href="lg-g-skins.php" />
<link rel="shortlink" href="lg-g-skins.php" />
...
<body class="html not-front not-logged-in page-lg-g-skins section-lg-g-skins">
...
<li class="last leaf itm itm--btn-menu-account"><a href="humans.php" class="btn-menu-account"><span class="inner"><i class="icn" aria-hidden="true">6</i><span class="title">Account</span></span></a></li>
    ...
    <div id="main" class="l-main">
        <a id="main-content"></a>
                ...
                <div class="inner">LG G5 Skins &amp; Wraps</div>
            </h1>
    ...
    <div class="group group--devices device-catalog group--full">
        <div class="group__inner">
            <ul class="devices-list devices-list--no-grouping">
                                    <li class="device-itm">
                        <a href="shop/lg-g5-skins.php" class="device pli-device-link">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">G5<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/lg-g4.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">G4<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/lg-g3.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">G3<span class="element-invisible"> Skins</span></h2>
            ...
            <div class="devices-excerpt">ACellShop  offers a wide selection of <a href="shop/lg-g5-skins.php">LG G5 skins</a>, as well as skins for the LG G4 and G3. Select your device to visit our infamous build it yourself customizer. Your device will never be the same.</div>
        </div>
    </div>
                        <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/lg-g-precision.jpg');">
                <div class="group__inner">
                    <div class="text">Precision. It's a term that a lot of skin companies like to use to describe their products, but at ACellShop it's a way of life. With the removable back of the LG G3 and G4, having a skin which is ultra-precise is of the utmost importance. With the LG G5, you'll need a precision-cut that works seamlessly with the modularity of the device itself. That's why we prototype each of our <a href="shop/lg-g5-skins.php">LG G5 skins</a>, LG G4 skins, and LG G3 skins over a thousand times. To make things even better, we produce really easy to follow application tutorial videos to ensure that our effort in supplying a perfect product isn't lost during installation.</div>
                </div>
            </div>
                    <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/lg-g-wearetheboss.jpg');">
                <div class="group__inner">
                    <div class="text">As the owner of an LG G series device, you have come to expect more flexibility, superior customization options, and a better experience. That's why you're here at dbrand. Our industry-leading 'build it yourself' skin interface is the most advanced customization tool on the internet, allowing you to see exactly how your LG G5, G4, or G3 will look with a ACellShop skin. You can mix and match different materials for different parts of your device to get the exact look you're going for. This is the part where you stop reading. Go customize your device.</div>
                </div>
            </div>
            </div>
        ...
        <nav class="l-breadcrumb"><h2 class="element-invisible">You are here</h2><ul class="breadcrumb"><li class="itm breadcrumb-start"><a href="index.php"><i class="icn" aria-hidden="true">&#8904;</i><span class="title">Home</span></a></li><li class="itm"><span class="nolink">LG G5 Skins &amp; Wraps</span></li></ul></nav>    </div>
...
<li class="leaf active-trail itm itm--hfx-sbracks itm--active-trail"><a href="lg-g-skins.php" class="hfx-sbracks active-trail active">LG G Skins</a></li>
