...
<!-- Mirrored from dbrand.com/audio-technica-skins by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Sep 2016 11:26:18 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <title>M50 and M50x Skins & Wraps // ACellShop</title>
...
<meta name="description" content="Looking for an Audio-Technica skin? Look no further. ACellShop offers the most precisely-fitted M50x skins and M50 skins on the planet." />
<meta name="abstract" content="Looking for an Audio-Technica skin? Look no further. ACellShop offers the most precisely-fitted M50x skins and M50 skins on the planet." />
<meta name="viewport" content="width=device-width, user-scalable=no" />
<meta name="generator" content="Drupal 7 (http://drupal.org)" />
<link rel="canonical" href="audio-technica-skins.php" />
<link rel="shortlink" href="audio-technica-skins.php" />
...
<body class="html not-front not-logged-in page-audio-technica-skins section-audio-technica-skins">
...
<li class="last leaf itm itm--btn-menu-account"><a href="humans.php" class="btn-menu-account"><span class="inner"><i class="icn" aria-hidden="true">6</i><span class="title">Account</span></span></a></li>
    ...
    <div id="main" class="l-main">
        <a id="main-content"></a>
                ...
                <div class="inner">M50 and M50x Skins &amp; Wraps</div>
            </h1>
    ...
    <div class="group group--devices device-catalog group--full">
        <div class="group__inner">
            <ul class="devices-list devices-list--no-grouping">
                                    <li class="device-itm">
                        <a href="shop/m50x.php" class="device pli-device-link">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">M50x<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/m50.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">M50<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/m40x.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">M40x<span class="element-invisible"> Skins</span></h2>
            ...
            <div class="devices-excerpt">ACellShop  offers a wide selection of M50x skins, as well as skins for the ATH-M50. Select your device to visit our infamous build it yourself customizer. Your device will never be the same.</div>
        </div>
    </div>
                        <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/audio-technica-wearetheboss.jpg');">
                <div class="group__inner">
                    <div class="text">Fact: Your Audio-Technica headphones look identical to every other set on the planet. You chose the ATH-M50 or M50x because you're not a sheep - you know better than to buy Beats. Shouldn't the look of your headphones match your desire for quality audio? Enter dbrand. With our industry-leading customization interface, you can preview your M50x skin exactly as it will appear on your headphones. Come see what all the hype is about.</div>
                </div>
            </div>
                    <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/audio-technica-customize.jpg');">
                <div class="group__inner">
                    <div class="text">Want each section of your M50 to be a different color? How about just the logo in black carbon fiber? Perhaps a three-tone combo to match your favorite sports team? Anything is possible at dbrand. Customize the base, ring, and logo with an M50 skin or M50x skin and get the look you've always dreamed of. What are you waiting for?</div>
                </div>
            </div>
            </div>
        ...
        <nav class="l-breadcrumb"><h2 class="element-invisible">You are here</h2><ul class="breadcrumb"><li class="itm breadcrumb-start"><a href="index.php"><i class="icn" aria-hidden="true">&#8904;</i><span class="title">Home</span></a></li><li class="itm"><span class="nolink">M50 And M50x Skins &amp; Wraps</span></li></ul></nav>    </div>
