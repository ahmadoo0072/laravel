...
<!-- Mirrored from dbrand.com/macbook-skins by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Sep 2016 11:26:10 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <title>Macbook Skins & Wraps // ACellShop</title>
...
<meta name="description" content="Looking for a MacBook skin? Look no further. ACellShop offers the most precisely-fitted MacBook Air and Pro Retina skins on the market and ships worldwide." />
<meta name="abstract" content="Looking for a MacBook skin? Look no further. ACellShop offers the most precisely-fitted MacBook Air and Pro Retina skins on the market and ships worldwide." />
<meta name="viewport" content="width=device-width, user-scalable=no" />
<meta name="generator" content="Drupal 7 (http://drupal.org)" />
<link rel="canonical" href="macbook-skins.php" />
<link rel="shortlink" href="macbook-skins.php" />
...
<body class="html not-front not-logged-in page-macbook-skins section-macbook-skins">
...
<li class="last leaf itm itm--btn-menu-account"><a href="humans.php" class="btn-menu-account"><span class="inner"><i class="icn" aria-hidden="true">6</i><span class="title">Account</span></span></a></li>
    ...
    <div id="main" class="l-main">
        <a id="main-content"></a>
                ...
                <div class="inner">Macbook Skins &amp; Wraps</div>
            </h1>
    ...
    <div class="group group--devices device-catalog group--full">
        <div class="group__inner">
            <ul class="devices-list devices-list--no-grouping">
                                    <li class="device-itm">
                        <a href="shop/macbook-pro-retina-13.php" class="device pli-device-link">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Pro Retina 13"<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/macbook-pro-retina-15.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Pro Retina 15"<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/macbook-retina-12-new.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">12" Retina<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/macbook-air-13.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Air 13"<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/macbook-air-11.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Air 11"<span class="element-invisible"> Skins</span></h2>
            ...
            <div class="devices-excerpt">ACellShop  offers a wide selection of 11" and 13" MacBook Air skins, skins for the 13" and 15" MacBook Pro Retina, as well as new 12" Retina MacBook skins. Select your device to visit our infamous build it yourself customizer. Your device will never be the same.</div>
        </div>
    </div>
                        <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/macbook-customization.jpg');">
                <div class="group__inner">
                    <div class="text">Let's face it: you and almost everyone you know owns a MacBook. They're beautiful pieces of precision-made hardware, but they all look the exact same. ACellShop is here to change that. Choose between any of our 16 textured MacBook skins, from carbon fiber to leather, and scratch-proof your Mac for good. Not only are our MacBook skins the highest precision on the planet, but they're also the easiest to apply thanks to our unparalleled how to apply tutorial videos. Select your device above to visit our fully interactive skin builder.</div>
                </div>
            </div>
                    <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/macbook-wearetheboss.jpg');">
                <div class="group__inner">
                    <div class="text">Take a second to think about how much time your Mac has spent in your bag, just floating around with your keys, change, lighter, or various other items that could easily scratch it. Putting a ACellShop skin on your MacBook Air or MacBook Pro Retina guarantees peace of mind. Just toss it in your bag and forget it. You're fully protected from scratches with a ACellShop skin.</div>
                </div>
            </div>
            </div>
        ...
        <nav class="l-breadcrumb"><h2 class="element-invisible">You are here</h2><ul class="breadcrumb"><li class="itm breadcrumb-start"><a href="index.php"><i class="icn" aria-hidden="true">&#8904;</i><span class="title">Home</span></a></li><li class="itm"><span class="nolink">Macbook Skins &amp; Wraps</span></li></ul></nav>    </div>
...
<li class="leaf active-trail itm itm--hfx-sbracks itm--active-trail"><a href="macbook-skins.php" class="hfx-sbracks active-trail active">MacBook Skins</a></li>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"7619304e7b","applicationID":"5390901","transactionName":"ZAZTMUNWDBAEB0xdXV1MZBdYGE0KCwBdTBxDC0E=","queueTime":0,"applicationTime":8,"atts":"SEFQRwtMHx4=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
