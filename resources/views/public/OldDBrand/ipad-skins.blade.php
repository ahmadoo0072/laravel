...
<!-- Mirrored from dbrand.com/ipad-skins by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Sep 2016 11:26:10 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <title>iPad Skins & Wraps // ACellShop</title>
...
<meta name="description" content="Looking for an iPad skin? Look no further. ACellShop offers the most precisely-fitted iPad skins on earth. Carbon fiber, leather, wood, and more. Starting at $10." />
<meta name="abstract" content="Looking for an iPad skin? Look no further. ACellShop offers the most precisely-fitted iPad skins on earth. Carbon fiber, leather, wood, and more. Starting at $10." />
<meta name="viewport" content="width=device-width, user-scalable=no" />
<meta name="generator" content="Drupal 7 (http://drupal.org)" />
<link rel="canonical" href="ipad-skins.php" />
<link rel="shortlink" href="ipad-skins.php" />
...
<body class="html not-front not-logged-in page-ipad-skins section-ipad-skins">
...
<li class="last leaf itm itm--btn-menu-account"><a href="humans.php" class="btn-menu-account"><span class="inner"><i class="icn" aria-hidden="true">6</i><span class="title">Account</span></span></a></li>
    ...
    <div id="main" class="l-main">
        <a id="main-content"></a>
                ...
                <div class="inner">iPad Skins &amp; Wraps</div>
            </h1>
    ...
    <div class="group group--devices device-catalog group--full">
        <div class="group__inner">
            <ul class="devices-list devices-list--no-grouping">
                                    <li class="device-itm">
                        <a href="shop/ipad-pro-9.php" class="device pli-device-link">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">iPad Pro 9.7"<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/ipad-pro-12.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">iPad Pro 12.9"<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/ipad-air-2.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">iPad Air 2<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/ipad-mini-4.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">iPad Mini 4<span class="element-invisible"> Skins</span></h2>
            ...
            <div class="devices-excerpt">ACellShop  offers a wide selection of 12.9" iPad Pro skins, 9.7" iPad Pro skins, iPad Air 2 skins, as well as skins for the iPad Mini 4. Select your device to visit our infamous build it yourself customizer. Your device will never be the same.</div>
        </div>
    </div>
                        <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/ipad-customize.jpg');">
                <div class="group__inner">
                    <div class="text">Let's face it: you and almost everyone you know owns an iPad. They're beautiful pieces of precision-made hardware, but they all look the exact same. ACellShop is here to fix that. Choose between any of our 23 textured <a href="shop/ipad-pro-12.php">12.9-inch iPad Pro skins</a>, from carbon fiber to leather, and scratch-proof your iPad for good. Not only are our iPad Air 2 skins and <a href="shop/ipad-pro-9.php">9.7-inch iPad Pro skins</a> the highest precision on the planet, but they're also the easiest to apply thanks to our unparalleled how to apply tutorial videos. Select your device above to visit our fully interactive iPad skin builder.</div>
                </div>
            </div>
                    <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/ipad-scratchprotection.jpg');">
                <div class="group__inner">
                    <div class="text">Take a second to think about how much time your iPad Pro, Air, or Mini has spent in your bag, just floating around with your keys, change, lighter, or various other items that could easily scratch it. Putting a ACellShop skin on your 9.7" iPad Pro, 12.9" iPad Pro, Air 2, or Mini 4 guarantees peace of mind. Just toss it in your bag and forget it. You're fully protected from scratches with our iPad Pro skins, iPad Air 2 skins, and iPad Mini 4 skins.</div>
                </div>
            </div>
            </div>
        ...
        <nav class="l-breadcrumb"><h2 class="element-invisible">You are here</h2><ul class="breadcrumb"><li class="itm breadcrumb-start"><a href="index.php"><i class="icn" aria-hidden="true">&#8904;</i><span class="title">Home</span></a></li><li class="itm"><span class="nolink">IPad Skins &amp; Wraps</span></li></ul></nav>    </div>
...
<li class="last leaf active-trail itm itm--hfx-sbracks itm--active-trail"><a href="ipad-skins.php" class="hfx-sbracks active-trail active">iPad Skins</a></li>
</ul></nav>
