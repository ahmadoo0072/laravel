...
<!-- Mirrored from dbrand.com/xperia-skins by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Sep 2016 11:26:19 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <title>Xperia Skins & Wraps // ACellShop</title>
...
<meta name="description" content="Looking for an Xperia skin? Look no further. ACellShop offers the most precisely-fitted Xperia skins on earth. Carbon fiber, leather, wood, and more. Starting at $8." />
<meta name="abstract" content="Looking for an Xperia skin? Look no further. ACellShop offers the most precisely-fitted Xperia skins on earth. Carbon fiber, leather, wood, and more. Starting at $8." />
<meta name="viewport" content="width=device-width, user-scalable=no" />
<meta name="generator" content="Drupal 7 (http://drupal.org)" />
<link rel="canonical" href="xperia-skins.php" />
<link rel="shortlink" href="xperia-skins.php" />
...
<li class="last leaf itm itm--btn-menu-account"><a href="humans.php" class="btn-menu-account"><span class="inner"><i class="icn" aria-hidden="true">6</i><span class="title">Account</span></span></a></li>
    ...
    <div id="main" class="l-main">
        <a id="main-content"></a>
                ...
                <div class="inner">Xperia Skins &amp; Wraps</div>
            </h1>
    ...
    <div class="group group--devices device-catalog group--full">
        <div class="group__inner">
            <ul class="devices-list devices-list--no-grouping">
                                    <li class="device-itm">
                        <a href="shop/xperia-z5.php" class="device pli-device-link">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xperia Z5<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xperia-z5-compact.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xperia Z5C<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xperia-z5-premium.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xperia Z5 Premium<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xperia-z3.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xperia Z3<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xperia-z3-compact.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xperia Z3C<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xperia-z2.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xperia Z2<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xperia-z1.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xperia Z1<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xperia-z-ultra.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xperia Z Ultra<span class="element-invisible"> Skins</span></h2>
            ...
            <div class="devices-excerpt">ACellShop  offers a wide selection of Xperia Z5 skins, as well as skins for the Xperia Z5 Compact and Z5 Premium. Select your device to visit our infamous <em>build it yourself</em> customizer. Your device will never be the same.</div>
        </div>
    </div>
                        <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/xperia-wearetheboss.jpg');">
                <div class="group__inner">
                    <div class="text">When we first saw the Xperia series of smartphones, excitement was on an all-time high. The clean glass canvas is literally begging to be skinned. The great part about Xperia skins is that, because of the glass surface they are applied to, they can be removed and re-used an infinite number of times. The glass surface is slippery, but that can be easily remedied with one of our grippy, textured, precision-fitted Xperia skins.</div>
                </div>
            </div>
                    <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/xperia-customization.jpg');">
                <div class="group__inner">
                    <div class="text">As an owner of an Xperia smartphone, you expect superior quality, more customization, and a cleaner experience. That's why you're here at dbrand. Our fully interactive skin builder is the most advanced Xperia skin customization tool on the internet, allowing you to preview your Xperia Z1, Z2, Z3, Z3 Compact, Z4, Z5, Z5 Compact, Z5 Premium, or Z Ultra exactly as it will look with a ACellShop skin. At the end of the day, only the most precise fit on earth is acceptable for your Xperia skin. Get yours today.</div>
                </div>
            </div>
            </div>
        ...
        <nav class="l-breadcrumb"><h2 class="element-invisible">You are here</h2><ul class="breadcrumb"><li class="itm breadcrumb-start"><a href="index.php"><i class="icn" aria-hidden="true">&#8904;</i><span class="title">Home</span></a></li><li class="itm"><span class="nolink">Xperia Skins &amp; Wraps</span></li></ul></nav>    </div>
...
</div><input type="submit" id="edit-submit" name="op" value="Sign Up" class="btn form-submit button" /><input type="hidden" id="form-b-ArxqtAAaN0fUeMdaVqTtAVAswvcasAnNnlf1W7ZxY" name="form_build_id" value="form-b-ArxqtAAaN0fUeMdaVqTtAVAswvcasAnNnlf1W7ZxY" />
...
<li class="leaf active-trail itm itm--hfx-sbracks itm--active-trail"><a href="xperia-skins.php" class="hfx-sbracks active-trail active">Xperia Skins</a></li>
