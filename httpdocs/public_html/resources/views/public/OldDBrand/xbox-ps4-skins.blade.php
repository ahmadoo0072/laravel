...
<!-- Mirrored from dbrand.com/xbox-ps4-skins by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Sep 2016 11:26:19 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <title>Xbox & PlayStation Skins & Wraps // ACellShop</title>
...
<meta name="description" content="Looking for an Xbox One skin, PS4 skin, or Xbox One S skin? Look no further. ACellShop offers the most customizable Xbox and PS4 wraps on earth." />
<meta name="abstract" content="Looking for an Xbox One skin, PS4 skin, or Xbox One S skin? Look no further. ACellShop offers the most customizable Xbox and PS4 wraps on earth." />
<meta name="viewport" content="width=device-width, user-scalable=no" />
<meta name="generator" content="Drupal 7 (http://drupal.org)" />
<link rel="canonical" href="xbox-ps4-skins.php" />
<link rel="shortlink" href="xbox-ps4-skins.php" />
...
<body class="html not-front not-logged-in page-xbox-ps4-skins section-xbox-ps4-skins">
...
<li class="last leaf itm itm--btn-menu-account"><a href="humans.php" class="btn-menu-account"><span class="inner"><i class="icn" aria-hidden="true">6</i><span class="title">Account</span></span></a></li>
    ...
    <div id="main" class="l-main">
        <a id="main-content"></a>
                ...
                <div class="inner">Xbox &amp; PlayStation Skins &amp; Wraps</div>
            </h1>
    ...
    <div class="group group--devices device-catalog group--full">
        <div class="group__inner">
            <ul class="devices-list devices-list--no-grouping">
                                    <li class="device-itm">
                        <a href="shop/xbox-one-s-skins.php" class="device pli-device-link">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xbox One S<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/sony-ps4-skins.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">PlayStation 4<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xbox-one-skins.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Xbox One<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/playstation-3.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">PlayStation 3<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/xbox-360.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">XBOX 360<span class="element-invisible"> Skins</span></h2>
            ...
            <div class="devices-excerpt">ACellShop  offers a wide selection of <a href="shop/xbox-one-s-skins.php">Xbox One S skins</a>, as well as <a href="shop/sony-ps4-skins.php">PS4 skins</a> and gaming controllers. Select your device to visit our infamous build it yourself customizer. Your console will never be the same.</div>
        </div>
    </div>
                        <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/gaming-fact.jpg');">
                <div class="group__inner">
                    <div class="text">Fact: The gaming console sitting under your TV right now is hidden away in shame. Collecting dust. Simply put, it's boring AF. Don't worry, that's where ACellShop comes in. With our industry-leading build it yourself customization interface, you can outfit your Xbox One, Xbox One S, or PS4 with a skin that will turn your console into a trophy piece. May or may not (but definitely will) increase your K/D.</div>
                </div>
            </div>
                    <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/gaming-customize.jpg');">
                <div class="group__inner">
                    <div class="text">Want each quadrant of your PS4 to be a different color? How about just the top left in Mahogany for a retro look? What if you totally lost your mind and wanted to turn your Xbox One into an eight-textured monstrosity? Anything is possible at dbrand: Customize each panel of your console with the exact <a href="shop/sony-ps4-skins.php">PS4 skin</a>, <a href="shop/xbox-one-skins.php">Xbox One skin</a> or <a href="shop/xbox-one-s-skins.php">Xbox One S</a> skin you want. What are you waiting for?</div>
                </div>
            </div>
            </div>
        ...
        <nav class="l-breadcrumb"><h2 class="element-invisible">You are here</h2><ul class="breadcrumb"><li class="itm breadcrumb-start"><a href="index.php"><i class="icn" aria-hidden="true">&#8904;</i><span class="title">Home</span></a></li><li class="itm"><span class="nolink">Xbox &amp; PlayStation Skins &amp; Wraps</span></li></ul></nav>    </div>
...
<li class="leaf active-trail itm itm--hfx-sbracks itm--active-trail"><a href="xbox-ps4-skins.php" class="hfx-sbracks active-trail active">Xbox &amp; PlayStation Skins</a></li>
