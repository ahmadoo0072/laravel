...
<!-- Mirrored from dbrand.com/htc-skins by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Sep 2016 11:26:17 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <title>HTC Skins & Wraps // ACellShop</title>
...
<meta name="description" content="Looking for an HTC skin? Look no further. ACellShop offers the most precise M7, M8, M9, and HTC 10 skins on the planet." />
<meta name="abstract" content="Looking for an HTC skin? Look no further. ACellShop offers the most precise M7, M8, M9, and HTC 10 skins on the planet." />
<meta name="viewport" content="width=device-width, user-scalable=no" />
<meta name="generator" content="Drupal 7 (http://drupal.org)" />
<link rel="canonical" href="htc-skins.php" />
<link rel="shortlink" href="htc-skins.php" />
...
<body class="html not-front not-logged-in page-htc-skins section-htc-skins">
...
<li class="last leaf itm itm--btn-menu-account"><a href="humans.php" class="btn-menu-account"><span class="inner"><i class="icn" aria-hidden="true">6</i><span class="title">Account</span></span></a></li>
    ...
    <div id="main" class="l-main">
        <a id="main-content"></a>
                ...
                <div class="inner">HTC Skins &amp; Wraps</div>
            </h1>
    ...
    <div class="group group--devices device-catalog group--full">
        <div class="group__inner">
            <ul class="devices-list devices-list--no-grouping">
                                    <li class="device-itm">
                        <a href="shop/htc-10-skins.php" class="device pli-device-link">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">HTC 10<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/htc-one-m9.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">HTC One M9<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/htc-one-m8.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">HTC One M8<span class="element-invisible"> Skins</span></h2>
                                    ...
                                    <li class="device-itm">
                        <a href="shop/htc-one-m7.php" class="device pli-device-link">
    <figure class="device-figure">
    ...
    <div class="device-title-wrapper">
        ...
        <h2 class="device-name">Nexus 9<span class="element-invisible"> Skins</span></h2>
            ...
            <div class="devices-excerpt">ACellShop  offers a wide selection of <a href="shop/htc-10-skins.php">HTC 10 skins</a>, as well as skins for the HTC One M9, M8, and M7. Select your device to visit our infamous build it yourself customizer. Your device will never be the same.</div>
        </div>
    </div>
                        <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/htc-wearetheboss.jpg');">
                <div class="group__inner">
                    <div class="text">HTC One skins. You could have gone anywhere to get them, but you're here for a reason. Maybe it was because our HTC One M9 skins were recommended by UnboxTherapy, MKBHD, LinusTechTips, and many more AAA influencers. Maybe it's because you're an avid follower of our infamous Twitter page and saw a wicked snapshot of an <a href="shop/htc-10-skins.php">HTC 10 skin</a>. At the end of the day, the fact of the matter is that you know the truth: only ACellShop makes the highest grade texture, most precisely fitted HTC skins on the planet. Is the hype real? Pick up an M7, M8, M9, or HTC 10 skin today to find out.</div>
                </div>
            </div>
                    <div class="group group--full group--device-collective-text-block" style="background-image:url('sites/default/files/images/shop/device-collective/htc-wearetheboss_0.jpg');">
                <div class="group__inner">
                    <div class="text">HTC has some of the highest build quality devices on the market. There's no denying it. With that being said, they're admittedly a bit slippery. Luckily, ACellShop is here to solve all your problems. Our skins add a ton of grip without any of the bulk. Our world famous 'build it yourself' customization interface offers millions of possible looks for your device. This is the part where you stop reading. Go customize your HTC 10 with a skin today.</div>
                </div>
            </div>
            </div>
        ...
        <nav class="l-breadcrumb"><h2 class="element-invisible">You are here</h2><ul class="breadcrumb"><li class="itm breadcrumb-start"><a href="index.php"><i class="icn" aria-hidden="true">&#8904;</i><span class="title">Home</span></a></li><li class="itm"><span class="nolink">HTC Skins &amp; Wraps</span></li></ul></nav>    </div>
...
<li class="last leaf active-trail itm itm--hfx-sbracks itm--active-trail"><a href="htc-skins.php" class="hfx-sbracks active-trail active">HTC Skins</a></li>
</ul></nav>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"7619304e7b","applicationID":"5390901","transactionName":"ZAZTMUNWDBAEB0xdXV1McAZFXg0NSgBaQgFsEFkKQWgGBhMNW1FtUAxdCVRUFgoTAWdEU1QG","queueTime":0,"applicationTime":196,"atts":"SEFQRwtMHx4=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>

<!-- Mirrored from dbrand.com/htc-skins by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Sep 2016 11:26:18 GMT -->
