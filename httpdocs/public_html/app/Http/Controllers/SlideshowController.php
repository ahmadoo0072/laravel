...
use ACellShop\src\Image\Traits\ImageUploadTrait;
use ACellShop\Http\Requests;
use ACellShop\Http\Controllers\Controller;
use Illuminate\Http\Request;
use ACellShop\src\Slideshow;
use ACellShop\src\Slide;
...
class SlideshowController extends Controller {
    ...
    {
        $this->_cropper = App::make('ACellShop\src\Image\Interfaces\ImageCropInterface');
        $this->_slide = $slide;
