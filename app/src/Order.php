...
class Order extends Model {
    ...
    {
        return $this->hasMany('ACellShop\src\OrderProduct', 'order_id', 'order_id');
    }
    ...
    {
        return $this->with('order_products')->orderBy('created_at', 'desc')->get();
    }
    ...
    {
        return User::where('order_id',$order_id) -> first();
    }
}
